...
const Ourservices = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollThreshold = 250; // Change this value to determine when the color change occurs
  ...
  return (
    <div className="py-24 flex flex-col-reverse lg:flex-row-reverse items-start  justify-between px-6 lg:px-28">
      <div className="w-auto font-nunito lg:w-full md:pt-10">
        <h1 className="text-2xl md:text-4xl font-bold">Our Services</h1>
        <p className="multiverse-text py-5 text-xl md:text-2xl w-auto md:w-[70%] 2xl:w-[60%]  font-bold ">
          A full-service integrated digital solutions agency, empowering brands
          to thrive in the digital age
        </p>
        <p
          className={`font-medium text-lg md:text-xl w-auto  md:w-[84.5%] 2xl:w-[75%] ${
